...
//
//
//        def record1 = new Record(player: Player.get(1), distance: 0, score:0).save(failOnError: true)
//        def record2 = new Record().save(failOnError: true)
//        def record3 = new Record().save(failOnError: true)
//        def record4 = new Record().save(failOnError: true)
////
////        def group1 = new Group().save()
//        def group2 = new Group(records: []).save(failOnError: true)
//        def group3 = new Group(records: []).save(failOnError: true)
//        def group4 = new Group(records: []).save(failOnError: true)
//
//
//
//        def set1= new Set(groups:[group1]).save(failOnError: true)
//
//        def round1 = new Round(sets: [set1]).save(failOnError: true)
//        def round2 = new Round(sets: []).save(failOnError: true)
//        def round3 = new Round(sets: []).save(failOnError: true)
//
//        def bracket = new Bracket(rounds:[round1]).save(failOnError: true)
//
//            def round1Players = []
//            def round2Players = []
//            def round3Players = []
//
//            (1..16).each {
//                round1Players << ldb.Player.get(it)
//            }
//            (17..32).each {
//                round2Players << ldb.Player.get(it)
//            }
//            (33..48).each {
//                round3Players << ldb.Player.get(it)
//            }
//
//            def set1Groups = []
//
...
//
//
////            new Group(players:ldb.Player.findAllByIdLessThan(5), id:1)
